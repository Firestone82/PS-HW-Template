...
Na základě grafického zobrazení (viz \TODO) a výběrové šikmosti a špičatosti (výběrová šikmost i špičatost \ul{leží \slash neleží} v intervalu (-2, 2) \ul{lze \slash nelze} předpokládat, že pozorovaný nárůst FPS má normální rozdělení. Dle \ul{pravidla 3$\sigma$ \slash Čebyševovy nerovnosti} lze tedy očekávat, že \ul{přibližně u 95 \% \slash alespoň 75 \%} naměřených nárůstů ve výkonu bude \TODO FPS až \TODO FPS.
